    ...
    public sealed class UsersLoopObjects : IUsersLoopObjects
    {
        ...
        public bool IsLoopObjectsForUserExist(Update update)
        {
            return (update.Type == UpdateType.Message && _usersLoopObjects.ContainsKey((long)update.Message?.Chat.Id!)) ||
                (update.Type == UpdateType.InlineQuery && _usersLoopObjects.ContainsKey((long)update.InlineQuery?.From.Id!));
        }
        ...
        public List<ILoopObject> GetLoopObjectsOfUser(Update update)
        {
            ...
            return _usersLoopObjects[(long)update.InlineQuery?.From.Id!];
        }
        ...
        public void CreateLoopObjectsForNewUser(Update update)
        {
            ...
            if (update.Type == UpdateType.InlineQuery && !_usersLoopObjects.ContainsKey((long)update.InlineQuery?.From.Id!))
                _usersLoopObjects.Add(update.InlineQuery.From.Id, _loopObjectsFactory.Create());
        }
    }
}